...
var MP4Parser = /** @class */ (function () {
    ...
    MP4Parser.prototype.parseAtom = function (parent, size) {
        var _this = this;
        // Parse atom header
        var offset = this.tokenizer.position;
    ...
    MP4Parser.prototype.parseAtomData = function (header, parent) {
        ...
        switch (header.name) {
            ...
            case "mdat":
                return this.tokenizer.readToken(new Token.IgnoreType(dataLen))
                    .then(function (buf) {
    ...
    MP4Parser.prototype.parseAtom_mvhd = function (len) {
        var _this = this;
        return this.tokenizer.readToken(new Atom.MvhdAtom(len)).then(function (mvhd) {
    ...
    MP4Parser.prototype.parseAtom_mdhd = function (len) {
        var _this = this;
        return this.tokenizer.readToken(new Atom.MdhdAtom(len)).then(function (mdhd) {
